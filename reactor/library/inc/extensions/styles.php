...
function reactor_register_styles() {
	...
	wp_register_style('foundation', get_template_directory_uri() . '/library/css/foundation.revised.css', array(), false, 'all');
	wp_register_style('mediumgrid', get_template_directory_uri() . '/library/css/medium-grid.css', array(), false, 'all');	
	wp_register_style('foundicons', get_template_directory_uri() . '/library/css/foundicons.css', array(), false, 'all');
	wp_register_style('reactor', get_template_directory_uri() . '/library/css/reactor-revised.css', array(), false, 'all');
	wp_register_style('style', get_stylesheet_directory_uri() . '/style.css?'.time(), array(), false, 'all');
}
