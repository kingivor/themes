...
<div class="discog">
			...
			<!-- FILTER CONTROLS -->
				...
				<div id="Filters" class="group">
					<div class="drop_down wf controls large-12 medium-12 small-12 columns">

						<h4>Record Type</h4>
						<ul class="anim250">
							<li data-dimension="records" data-filter="all" class="active" >All</li>
							<li data-dimension="records" data-filter="albums">Albums</li>
							<li data-dimension="records" data-filter="singles">Singles</li>
							<li data-dimension="records" data-filter="compilations">Compilations</li>
						...
						<h4>Sort</h4>
						<ul>
							<li class="sort active" data-sort="data-year" data-order="asc">Newer</li>
							<li class="sort" data-sort="data-year" data-order="desc">Older</li>
							<li class="sort" data-sort="data-name" data-order="desc">A&rarr;Z</li>
							<li class="sort" data-sort="data-name" data-order="asc">Z&rarr;A</li>
...
-->					<div class="controls large-12 medium-12 small-12 columns">
					</div>
...
<li class="mix <?php echo $discog_cats; ?>" data-name="<?php echo $discog_title; ?>" data-year="<?php echo $discog_year; ?>">
	...
	<h5><?php echo $discog_title ?></h5>
	<h6><?php echo $discog_year ?></h6>
</li>
